...
plot(usap$vs, usap$gr + usap$ir + usap$gn + usap$dv, xlab="Vote Share", ylab="Growth Rate", main="Vote Share vs Growth Rate")
summary(modelB)
plot(modelB)
...
plot(usap$vs, usap$gr + usap$ir + usap$gn + usap$dv + usap$pr + usap$pwh + usap$pr*usap$pwh, xlab="Vote Share", ylab="Growth Rate", main="Vote Share vs Growth Rate")
summary(modelC)
plot(modelC)
...
anova(modelA, modelB)
comparator <- anova(modelB, modelC)
comparator
plot(comparator)
